...
module.exports.builder = function(yargs) {
  return yargs
    ...
    .option('ldap-group-membership', {
      describe: 'Group of members allowed authorization via LDAP, format AA=OneTeam, BB=AnotherTeam'
      , type: 'string'
      , default: process.env.LDAP_GROUP_MEMBERSHIP
    })
  ...
  return require('../../units/auth/ldap')({
    ...
    , ldap: {
      ...
      , bind: {
        ...
        , ldapGroupMembership: argv.ldapGroupMembership
      }
      , search: {
