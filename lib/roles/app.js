...
module.exports = function(options) {
  ...
  app.use('/static/intro',
    express.static(pathutil.resource('bower_components/stf-site/intro')))
  app.use('/static/manual',
    express.static(pathutil.resource('bower_components/stf-site/manual')))
  app.use('/static/v2-features',
    express.static(pathutil.resource('bower_components/stf-site/v2-features')))
  app.use('/static/data', express.static(pathutil.resource('data')))
  app.use('/static/build', express.static(pathutil.resource('build')))
