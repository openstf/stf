    ...
    switch (req.accepts(['json'])) {
      case 'json':
        requtil.validate(req, function() {
          ...
          .then(function(user) {
            var isMemberOfGroup = ldaputil.checkUserMembership(options.ldap.bind.ldapGroupMembership, user.memberOf);
            if(!isMemberOfGroup) {
              return Promise.reject(new ldaputil.InvalidCredentialsError(user));
            }
