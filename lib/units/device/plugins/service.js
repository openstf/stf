...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, router, push, apk) {
    ...
    function callService(intent) {
      return adb.shell(options.fixed_serial, util.format(
    ...
    function openService() {
      ...
      return callService(util.format(
        ...
        .then(function() {
          return devutil.waitForLocalSocket(adb, options.fixed_serial, service.sock)
            .timeout(15000)
        })
        .then(function(conn) {
          service.socket = conn
    ...
    function openAgent() {
      ...
      return stopAgent()
        .timeout(15000)
        .then(function() {
          return devutil.ensureUnusedLocalSocket(adb, options.fixed_serial, agent.sock)
            .timeout(10000)
        })
        .then(function() {
          return adb.shell(options.fixed_serial, util.format(
        ...
        .then(function() {
          return devutil.waitForLocalSocket(adb, options.fixed_serial, agent.sock)
            .timeout(10000)
        })
        .then(function(conn) {
          agent.socket = conn
    ...
    plugin.identity = function() {
      return runServiceCommand(
        ...
        , new apk.wire.DoIdentifyRequest(options.fixed_serial)
        )
        .timeout(10000)
        .then(function(data) {
