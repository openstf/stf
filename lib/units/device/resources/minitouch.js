...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, abi) {
    ...
    function removeResource(res) {
      return adb.shell(options.fixed_serial, ['rm', res.dest])
        .timeout(10000)
        .then(function(out) {
    ...
    function pushResource(res) {
      return adb.push(options.fixed_serial, res.src, res.dest, res.mode)
        .timeout(10000)
    ...
    function installResource(res) {
      ...
      function checkExecutable(res) {
        return adb.stat(options.fixed_serial, res.dest)
          .timeout(5000)
          .then(function(stats) {
