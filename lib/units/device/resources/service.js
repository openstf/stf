...
module.exports = syrup.serial()
  ...
  .define(function(options, adb) {
    ...
    function getPath() {
      return adb.shell(options.fixed_serial, ['pm', 'path', resource.pkg])
        .timeout(10000)
        .then(function(out) {
    ...
    function install() {
      ...
      return getPath()
        ...
        .catch(function() {
          ...
          // issues.
          return adb.uninstall(options.fixed_serial, resource.pkg)
            .timeout(15000)
            .then(function() {
              return promiseutil.periodicNotify(
                  adb.install(options.fixed_serial, resource.apk)
                , 20000
                )
                .timeout(65000)
            })
