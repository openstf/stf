...
module.exports = function(options) {
  ...
  function listenReserveMessages() {
    sub.on('message', wirerouter()
      ...
      .on(wire.ReserveEnforceRequest, function(channel, message) {
        log.debug('enforce reservation request')
        dbapi.getSchedule(message.id)
          .then(function(schedule, message) {
            return enforce(schedule)
          })
      })
      .handler())
  }

  function enforce(schedule, message) {
