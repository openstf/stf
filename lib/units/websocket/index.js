  ...
  io.on('connection', function(socket) {
    ...
    new Promise(function(resolve) {
      socket.on('disconnect', resolve)
        ...
        .on('avd.restart', function(emulatorName, serial, user) {
          function getEmulatorArgsAndRestart(serial, emulatorName, output) {
            dbapi.getEmulatorStartArgs(serial).then(function(args) {
              var message = Object.create(null)
              message.emulator_name = emulatorName
              message.port = serial
          ...
          if (typeof user !== 'undefined') {
              dbapi.loadDevice(serial).then(function(device) {
                  ...
                  if (proceed || (user.name === device.owner.name &&
                    ...
                    getEmulatorArgsAndRestart(serial, emulatorName, output)
                    })
                  }
                  else {
